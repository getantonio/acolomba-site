...
- 2026-07-10 [Review] Refined the dark Sound-a-tude web player only: removed the stacked speaker-picker focus treatment after voice changes, replaced the Lip and clickable Pitch controls with one playback-speed slider, and locked pitch steady at every speed. Local verification is complete; awaiting approval to publish.
